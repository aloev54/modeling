...
def clearPrint(u, analitical, euler, picar1, picar2, picar3, picar4):
    for i in range(len(u)):
        print("u =", round(u[i], 3), "\t", "anal= ", round(analitical[i], 3), "\t", "euler= ", round(euler[i], 3), "\t",
              "picar1= ", round(picar1[i], 3), "\t", "picar2= ", round(picar2[i], 3), "\t", "picar3= ",
              round(picar3[i], 3), "\t", "picar4= ", round(picar4[i], 3))
